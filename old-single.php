		...
		<div class="<?php echo 'col-lg-12 col-md-12 col-sm-12' ; ?>">
			...
			<div class="blog-post-single <?php echo esc_attr($full_class); ?>">
				...
				<div class="post-meta-track animate-onscroll">
					...
					<table class="project-details">
						...
						<tr>
							...
							<td class="tags"><?php esc_html_e( 'Tags', THEMENAME ); ?>: <?php echo get_the_tag_list( '', ', ' ); ?></td>
						</tr>
				...
				<div class="post-author animate-onscroll">
					...
					<h4><?php // printf( esc_attr__( 'About %s', THEMENAME ), get_the_author() ); ?></h4>
			...
			<div class="related-articles">
				...
				<h3 class="animate-onscroll"><?php esc_html_e( 'Related Articles', THEMENAME ); ?></h3>
