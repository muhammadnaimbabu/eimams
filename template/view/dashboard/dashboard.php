                    ...
                    <div class="d-flex align-items-center mb-6">
                        ...
                        <div class="d-flex align-items-center flex-wrap w-100">
                            <div class="mb-1 pe-3 flex-grow-1">
                                ...
                                <div class="text-gray-400 fw-semibold fs-7">Jobs that you have posted.
                                </div>
                            </div>
                            <div class="d-flex align-items-center">
                                <div class="fw-bold fs-5 text-gray-800 pe-1"><?php echo  kv_get_total_jobs_counts($current_user->ID); ?></div>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-6">
                        ...
                        <div class="d-flex align-items-center flex-wrap w-100">
                            <div class="mb-1 pe-3 flex-grow-1">
                                <a href="#" class="fs-5 text-gray-800 text-hover-primary fw-bold">Expired Jobs</a>
                                <div class="text-gray-400 fw-semibold fs-7">Those are expired.
                                </div>
                            </div>
                            <div class="d-flex align-items-center">
                                <div class="fw-bold fs-5 text-gray-800 pe-1"><?php echo  kv_get_expired_jobs_counts($current_user->ID); ?></div>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex align-items-center mb-6">
                        ...
                        <div class="d-flex align-items-center flex-wrap w-100">
                            <div class="mb-1 pe-3 flex-grow-1">
                                <a href="#" class="fs-5 text-gray-800 text-hover-primary fw-bold">Pending Jobs</a>
                                <div class="text-gray-400 fw-semibold fs-7">Jobs that aren't approved yet.
                                </div>
                            </div>
                            <div class="d-flex align-items-center">
                                <div class="fw-bold fs-5 text-gray-800 pe-1"><?php echo  kv_get_pending_jobs_counts($current_user->ID); ?></div>
                            </div>
                        </div>
                    </div>
                    <div class="d-flex align-items-center ">
                        ...
                        <div class="d-flex align-items-center flex-wrap w-100">
                            <div class="mb-1 pe-3 flex-grow-1">
                                <a href="<?php echo site_url('applied-resumes') ?>" class="fs-5 text-gray-800 text-hover-primary fw-bold">Applications</a>
                                <div class="text-gray-400 fw-semibold fs-7">N. of Applications received.
                                </div>
                            </div>
                            <div class="d-flex align-items-center">
                                <div class="fw-bold fs-5 text-gray-800 pe-1"><?php echo  get_current_read_applied_resumes(true); ?></div>
                            </div>
                        </div>
                    </div>
                </div>
